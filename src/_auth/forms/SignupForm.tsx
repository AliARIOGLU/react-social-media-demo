...
const SignupForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof SignupFormValidationSchema>) {
    ...
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <p className="text-light-3 small-medium md:base-regular mt-2">
          Tou use Snapgram, please enter your details
        </p>
        ...
        >
          ...
          <p className="text-small-regular text-light-2 text-center mt-2">
            ...
            <Link
              to="/sign-in"
              className="text-primay-500 text-small-semibold ml-1 hover:underline"
            >
              Log in
            </Link>
          </p>
