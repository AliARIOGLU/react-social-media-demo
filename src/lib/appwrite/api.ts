...
export async function signInAccount(user: { email: string; password: string }) {
  try {
    ...
    console.log("[ERROR_SIGNINACCOUNT]", error);
  }
}
...
export function getFilePreview(fileId: string) {
  try {
    ...
    console.log("[GET_FILE_PREV_ERROR]", error);
  }
}
...
export async function getPostById(postId: string) {
  try {
    ...
    console.log("[GET_POSTBYID_ERROR]", error);
  }
}
...
export async function getInfinitePosts({ pageParam }: { pageParam: number }) {
  ...
  try {
    ...
    console.log("[GET_INFINITEPOSTS_ERROR]", error);
  }
}
...
export async function savePost(postId: string, userId: string) {
  try {
    ...
    console.log("[SAVE_POST_ERROR]", error);
  }
}
...
export async function deleteSavedPost(savedRecordId: string) {
  try {
    ...
    console.log("[DELETE_SAVEDPOST_ERROR]", error);
  }
}
